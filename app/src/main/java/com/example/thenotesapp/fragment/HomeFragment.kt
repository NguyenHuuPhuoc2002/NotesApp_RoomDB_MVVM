...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider{
    private var homeBingding: FragmentHomeBinding? = null
    private val binding get() = homeBingding!!
    ...
    override fun onCreateView(
        ...
        homeBingding = FragmentHomeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setuoHomeRecycleView(){
